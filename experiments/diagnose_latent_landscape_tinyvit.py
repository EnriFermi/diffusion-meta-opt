...
def parse_args() -> LandscapeConfig:
    ...
    parser.add_argument("--big_vae_decode", choices=("weights", "all"), default="all")
    parser.add_argument("--big_vae_tile_T_patches", type=int, default=16)
    parser.add_argument("--big_vae_tile_d_out", type=int, default=8)
