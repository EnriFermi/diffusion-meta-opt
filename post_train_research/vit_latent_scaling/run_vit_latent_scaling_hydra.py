...
def build_vit_latent_scaling_configs(cfg: DictConfig) -> tuple[ScalingRunConfig, ViTTinyConfig]:
    ...
    run_cfg = ScalingRunConfig(
        ...
        latent_lr_decay_steps=int(run_cfg_raw.get("latent_lr_decay_steps", 5250)),
        latent_debug_log_deltas=bool(run_cfg_raw.get("latent_debug_log_deltas", False)),
        latent_debug_jacobian_eps=float(run_cfg_raw.get("latent_debug_jacobian_eps", 1e-3)),
        latent_debug_jacobian_probes=int(run_cfg_raw.get("latent_debug_jacobian_probes", 16)),
        ...
        big_vae_random_init_std=float(run_cfg_raw.get("big_vae_random_init_std", 0.02)),
