...
- `big_vae/models/distribution_encoder.py`
- `big_vae/models/mini_patch_vae.py`
- `big_vae/models/patch_tokenizers.py`
- `big_vae/models/big_weight_vae.py`
- `big_vae/models/big_weight_vae_parts/`
- `big_vae/models/vae_shared.py`
- `conf/big_vae/train/`

Основной публичный model API теперь `big_vae.models`; реализация BigVAE разложена
между `big_vae/models/big_weight_vae.py` и `big_vae/models/big_weight_vae_parts/`.
New training runs should use `conf/big_vae/train/` and `scripts/launchers/big_vae/`.
...
### InputDistributionEncodingModule (`big_vae.models`)
...
### MiniPatchEncoder (`big_vae.models`)
...
## Model dataclasses (`big_vae.models`)
...
```bash
python -m big_vae.models.big_weight_vae
```
